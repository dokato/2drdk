...
jsPsych.plugins['image-selector-fb-tut'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-selector-fb-tut', 'stimulus', 'image');

  plugin.info = {
    name: 'image-selector-fb-tut',
    description: '',
    parameters: {
      stimulus: {
  ...
  //  var stim_view = [trial.stimulus[0], trial.prompt, trial.stimulus[1]];
    function show_images() {
      ...
      //start with prompt
      var html = ''//'<img src ="'+trial.prompt+ '"></img>';   // id="jspsych-image-slider-2AFC-"
      ...
      html += '<div class="blink">Click on the bigger item</div>'
