...
jsPsych.plugins['image-selector'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-selector', 'stimulus', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_images() {
      ...
      //html +=  '<div class="w3-green" style="height:24px;width:25%"></div>';
      //html += '</div><br>'
