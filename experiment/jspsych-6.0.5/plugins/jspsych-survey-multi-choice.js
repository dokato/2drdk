...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML = '<style id="jspsych-survey-multi-choice-css" style="background:#d3d3d3;"></style>';
    var cssstr = ".jspsych-survey-multi-choice-question { margin-top: 1em; margin-bottom: 1em; text-align: left; }"+
      ".jspsych-survey-multi-choice-text span.required {color: darkred;}"+
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: center;}"+
      ".jspsych-survey-multi-choice-option { line-height: 2; margin-left: 10em;}"+
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {  display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top; font-size: 14px;}"+
    ...
    display_element.innerHTML += '<form id="'+trial_form_id+'" style="background:#d3d3d3;padding:15px;"></form>';
    ...
    for (var i = 0; i < trial.questions.length; i++) {
        ...
        // add question text
        display_element.querySelector(question_selector).innerHTML += '<p class="' + plugin_id_name + '-text survey-multi-choice" style="font-size:14px">' + trial.questions[i].prompt + '</p>';
      ...
      for (var j = 0; j < trial.questions[i].options.length; j++) {
        ...
        display_element.querySelector(question_selector).innerHTML += '<div id="'+option_id_name+'" class="'+_join(plugin_id_name, 'option')+'" style="margin-left:15em"></div>';
